...
class LF_WP_List_Table {
	...
	public function ajax_user_can() {
		die( 'function LF_WP_List_Table::ajax_user_can() must be over-ridden in a sub-class.' );
	}

	/**
	 * Prepares the list of items for displaying.
	 * @uses LF_WP_List_Table::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @access public
	 * @abstract
	...
	public function prepare_items() {
		die( 'function LF_WP_List_Table::prepare_items() must be over-ridden in a sub-class.' );
	}
...
<?php
	...
	public function get_columns() {
		die( 'function LF_WP_List_Table::get_columns() must be over-ridden in a sub-class.' );
	}
